...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-brand-navy text-white shadow-sm hover:bg-brand-navy-dark active:translate-y-px",
        accent:
          "bg-brand-gold text-white shadow-sm hover:bg-brand-gold-dark active:translate-y-px",
        outline:
          "border border-brand-mist bg-white text-brand-ink hover:border-brand-navy/40 hover:text-brand-navy",
        ghost: "text-brand-ink hover:bg-brand-mist/60",
        soft: "bg-brand-mist/60 text-brand-navy hover:bg-brand-mist",
