...
export const adviceSchema = z.object({
  intent: z.enum(["conversation", "explain", "clarify", "recommend", "preferences", "goal"]).optional(),
  summary: z.string().min(1).max(1200),
  summary_evidence_ids: z.array(z.string().max(140)).max(12).optional(),
  consultation_draft: consultationAnswersSchema.nullable().optional(),
...
export type AssistantResult = {
  ...
  toolCalls?: import("./tools").AssistantToolCall[];
